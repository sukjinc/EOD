...
// Give credits to https://github.com/matabii/scale-imageview-android
...
public class ScaleImageView extends ImageView implements OnTouchListener {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(gestureDetector != null && previousMotionEvent != null)
        {
            VelocityTracker velocityTracker = VelocityTracker.obtain();
            gestureDetector.onFling(previousMotionEvent, event, velocityTracker.getXVelocity(), velocityTracker.getYVelocity());
    ...
    public void setGestureDetector(SwipeGestureDetector gestureDetector)
    {
